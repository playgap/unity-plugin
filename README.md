...
4. Grant additional rewards for Claiming when the user returns online

## How to Install the SDK using .unitypackage
...
## What setups does the SDK work with <a name="how-to-use"></a>
...
1. Ensure the LoadRewarded returned an unused Playgap Ad
...
The NetworkObserver is a utility which exposes the connection state of the user and provides updates the moment that a connection change occurs. To use it effectively:
